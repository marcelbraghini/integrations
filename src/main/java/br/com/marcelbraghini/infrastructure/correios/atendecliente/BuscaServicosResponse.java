...
/**
 * <p>Classe Java de buscaServicosResponse complex type.
 * 
...
@XmlType(name = "buscaServicosResponse", propOrder = {
    "_return"
})
public class BuscaServicosResponse {

    @XmlElement(name = "return")
    protected List<ServicoERP> _return;
     ...
     * 
     */
    public List<ServicoERP> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ServicoERP>();
        }
        return this._return;
    }
